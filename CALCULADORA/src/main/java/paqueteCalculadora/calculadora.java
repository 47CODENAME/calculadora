...
public class calculadora extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        led.setBackground(new java.awt.Color(51, 102, 0));
        led.setFont(new java.awt.Font("Segoe UI", 0, 36)); // NOI18N
        led.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        led.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        led.setOpaque(true);
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(17, 17, 17)
                .addComponent(led, javax.swing.GroupLayout.PREFERRED_SIZE, 54, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(28, 28, 28)
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        this.primerNumero = Float.parseFloat(this.led.getText());
        this.operador =("-");
        this.led.setText("");
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
        this.segundoNumero=Float.parseFloat(this.led.getText());
        
        switch(this.operador){
            case "+": this.led.setText(sinCero(this.primerNumero + this.segundoNumero)); break;
            case "-": this.led.setText(sinCero(this.primerNumero - this.segundoNumero)); break;
            case "x": this.led.setText(sinCero(this.primerNumero * this.segundoNumero)); break;
            case "/": if(this.segundoNumero==0){ this.led.setText("noSeDividePor0");}
            else {this.led.setText(sinCero(this.primerNumero / this.segundoNumero)); break;}
        }
    }//GEN-LAST:event_jButton16ActionPerformed

    private void jButton23ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton23ActionPerformed
        if(!(this.led.getText().contains("."))){
            this.led.setText(this.led.getText()+".");
    }
    ...
    private void jButton21ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton21ActionPerformed
        this.led.setText(this.led.getText()+"0");       // TODO add your handling code here:
    }//GEN-LAST:event_jButton21ActionPerformed

    private void jButton20ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton20ActionPerformed
        this.led.setText(this.led.getText()+"1");        // TODO add your handling code here:
    }//GEN-LAST:event_jButton20ActionPerformed

    private void jButton19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton19ActionPerformed
       this.led.setText(this.led.getText()+"2"); // TODO add your handling code here:
    }//GEN-LAST:event_jButton19ActionPerformed

    private void jButton18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton18ActionPerformed
        this.led.setText(this.led.getText()+"3");        // TODO add your handling code here:
    }//GEN-LAST:event_jButton18ActionPerformed

    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        this.led.setText(this.led.getText()+"4");        // TODO add your handling code here:
    }//GEN-LAST:event_jButton11ActionPerformed

    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        this.led.setText(this.led.getText()+"5");        // TODO add your handling code here:
    }//GEN-LAST:event_jButton12ActionPerformed

    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        this.led.setText(this.led.getText()+"6");        // TODO add your handling code here:
    }//GEN-LAST:event_jButton13ActionPerformed

    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        this.led.setText(this.led.getText()+"7");        // TODO add your handling code here:
    }//GEN-LAST:event_jButton7ActionPerformed

    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        this.led.setText(this.led.getText()+"8");        // TODO add your handling code here:
    }//GEN-LAST:event_jButton6ActionPerformed

    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        this.led.setText(this.led.getText()+"9");        // TODO add your handling code here:
